    ...
    class Program
    {
        ...
        private static void Seed(MovieContext context)
        {
            ...
            var Actors = new List<Actor> {
                      ...
                      new Actor { Name = "jeff goldblum", DateOfBirth = DateTime.Parse("9/22/1952",new CultureInfo("en-us")) },
                      new Actor { Name = "sam neill", DateOfBirth =   DateTime.Parse("9/14/1947",new CultureInfo("en-us")) },
                      new Actor { Name = "laura dern", DateOfBirth =   DateTime.Parse("2/10/1967",new CultureInfo("en-us")) },
                      new Actor { Name = "richard attenborough", DateOfBirth =   DateTime.Parse("8/29/1923",new CultureInfo("en-us")) },
                      new Actor { Name = "samuel l. jackson", DateOfBirth =   DateTime.Parse("12/21/1948",new CultureInfo("en-us")) },
                     #endregion

                     #region Star Wars
                      new Actor { Name = "Mark Hamill", DateOfBirth = DateTime.Parse("9/25/1951",new CultureInfo("en-US")) },
                      new Actor { Name = "Carrie Fisher", DateOfBirth = DateTime.Parse("10/21/1956",new CultureInfo("en-US")) },
                      new Actor { Name = "Harrison Ford", DateOfBirth = DateTime.Parse("7/13/1942",new CultureInfo("en-US")) },
                      new Actor { Name = "David Prowse", DateOfBirth = DateTime.Parse("7/1/1935",new CultureInfo("en-US")) },
                     #endregion

                     #region Forrest Gump
                      new Actor { Name = "Tom Hanks", DateOfBirth = DateTime.Parse("7/9/1956",new CultureInfo("en-US")) },
                      new Actor { Name = "Robin Wright", DateOfBirth = DateTime.Parse("4/8/1966",new CultureInfo("en-US")) },
                      new Actor { Name = "Gary Sinise", DateOfBirth = DateTime.Parse("3/17/1955",new CultureInfo("en-US")) },
                     #endregion

                     #region GoldenEye
                      new Actor{ Name = "Pierce Brosnan", DateOfBirth =   DateTime.Parse("5/16/1953",new CultureInfo("en-US")) },
                      new Actor{ Name = "Famke Janssen", DateOfBirth =   DateTime.Parse("9/5/1964",new CultureInfo("en-US")) },
                      new Actor{ Name = "Judi Dench", DateOfBirth =   DateTime.Parse("12/9/1934",new CultureInfo("en-US")) },
                     #endregion

                      #region The World Is Not Enough
                      new Actor{ Name = "Sophie Marceau", DateOfBirth =   DateTime.Parse("11/17/1966",new CultureInfo("en-US")) },
                      #endregion

                      #region Die Another Day
                      new Actor{ Name = "Halle Berry", DateOfBirth =   DateTime.Parse("8/14/1966",new CultureInfo("en-US")) },
                      #endregion

                      #region Tomorrow Never Dies
                      new Actor{ Name = "Michelle Yeoh", DateOfBirth =   DateTime.Parse("8/6/1962",new CultureInfo("en-US")) },
                      #endregion

                      #region Skyfall
                      new Actor{ Name = "Daniel Craig", DateOfBirth =   DateTime.Parse("3/2/1968",new CultureInfo("en-US")) },
                      new Actor{ Name = "Javier Bardem", DateOfBirth =   DateTime.Parse("3/1/1969",new CultureInfo("en-US")) },
                      #endregion

                      #region Casino Royale
                      new Actor{ Name = "Eva Green", DateOfBirth =   DateTime.Parse("7/6/1980",new CultureInfo("en-US")) },
                      new Actor{ Name = "Mads Mikkelsen", DateOfBirth =   DateTime.Parse("11/22/1965",new CultureInfo("en-US")) },
                      #endregion

                       #region Jurassic Park
                        new ActorMovie { ActorID = Actors.Single(g => g.Name == "Jeff Goldblum").ActorId, Character = "Ian Malcolm",
        ...
        new ActorMovie
        {
            ActorId = Actors.Single(g => g.Name == "Jeff Goldblum").ActorId,
